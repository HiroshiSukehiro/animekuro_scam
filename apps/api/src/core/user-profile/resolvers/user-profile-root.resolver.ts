...
export class UserProfileQueryType {
    ...
    @Field(() => GetAnimesGenresWithStatisticResultsType, {
        description: 'Get genres from folder with statistic',
    })
    getFavouriteGenresWithStatistic: GetAnimesGenresWithStatisticResultsType;

    @Field(() => GetAnimesStudiosWithStatisticResultsType, {
        description: 'Get studios from folder with statistic',
    })
    getFavouriteStudiosWithStatistic: GetAnimesStudiosWithStatisticResultsType;
}
